    ...
    <AuthProvider>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/login" element={<Login />} />          <Route path="/verify/:token" element={<Verify />} />
          ...
          <a href="/student/request" className="hover:text-blue-600">New Request</a> <Route path="/student/notifications" element={
<ProtectedRoute roles={['student']}><a href="/student/request" className="hover:text-blue-600">New Request</a> <Notifications /></ProtectedRoute>
} />

<Route path="/student/messages" element={
<ProtectedRoute roles={['student']}><Messages /></ProtectedRoute>
} />

<Route path="/student/locker" element={
<ProtectedRoute roles={['student']}><DigitalLocker /></ProtectedRoute>
} />
